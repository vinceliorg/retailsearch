...
embedding_dir = '/Users/vli/Work/RetailSearch/MagpieSearch/data/embeddings/jobs'
...
data_files = [f for f in listdir(data_dir) if isfile(join(data_dir, f)) and '.json' in f and 'seek' in f]
